...
<div class="title bx-border brt-none bg-white w-100 mb-20">
    <h4 class="t-uppercase ds-inline-block p-relative"><a href="" title=""><?=$title?></a></h4>
</div>
<div class="content w-100 clearfix">
	<div class="order-right border-order bx-border f-right">
		...
		<?php } ?>
		<div class="row-order bx-border pd-10 clearfix">
	...
	<form method="post" name="frm_order" id="frm-order" action="thanh-toan.html" enctype="multipart/form-data">
		<div class="order-left f-left">
			<div class="box-form w-100 border-order f-left">
				<div class="order-title border-bottom-order">
				...
				<div class="order-desc">
					<div class="order-form ">
						...
						<div class="row-order-form mb-10 clearfix">
							...
							<div class="row-input f-right">
								<input type="text" class="text-order" name="diachi" id="diachi" value="<?=$_SESSION['logging']['diachi']?>" placeholder="Ví dụ: 106 Bàu Cát 1. Phường 14, Quận Tân Bình">
								<p class="error-text cl-red"></p>
							</div>
						</div>
						...
						<div class="member-down">
							...
							<div class="row-order-form clearfix">
								<label class="f-left">Địa chỉ</label>
								<div class="row-input f-right">
									<input type="text" class="text-order" name="diachi_nguoinhan" id="diachi_nguoinhan" value="<?=$_SESSION['logging']['diachi']?>" placeholder="Ví dụ: 106 Bàu Cát 1. Phường 14, Quận Tân Bình">
									<p class="error-text cl-red"></p>
								</div>
							</div>
						</div>
