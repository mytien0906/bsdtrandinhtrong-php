...
<script type="text/javascript">
	...
	function onSearch(evt) {	
			...
			location.href = "index.php?com=tintuc&act=man&keyword="+keyword;
...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=tintuc&act=delete&listid=" + listid+a.value;
});
});
</script>
...
<?php 
	function get_level($i,$id)
	{
		...
		$d->reset();
		$sql="select id,ten_vi as ten from #_tintuc_list where level='$i' $ssql and type='".$_GET['type']."' order by stt,id desc";
		$d->query($sql);
		$res=$d->result_array();
                ...
                <table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							<td>
								  <?php
									$sql_danhmuc="select ten_vi from table_tintuc_list where id='".$items[$i]['id_lv'.$j]."'";
