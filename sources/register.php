<?php
	...
	if(!empty($_POST)){
        ...
        $data['hoten'] = (string)checkDL($form['hoten']);
		$data['dienthoai'] = (string)checkDL($form['dienthoai']);
                                                ...
                                                <td align="justify" style="padding:20px 15px 5px">
                                                    <table width="100%" style="text-align:center;font-size:11px;border-top:1px solid #13c1c9;border-bottom:1px solid #13c1c9">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding:10px 0">
                                                                    <a href="http://'.$config_url.'/lien-he" style="text-decoration:none;font-weight:bold;color:#262626;font-family:Helvetica,Arial,sans-serif">SUPPORT</a>
                                                                </td>
                                                                <td style="padding:10px 0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="padding-right:10px">
                                                                    <a href="http://'.$config_url.'/dieu-khoan-su-dung" style="text-decoration:none;color:#9a9a9a;font-family:Helvetica,Arial,sans-serif">Điều khoản sử dụng</a>
                                                                </td>
                                                                <td style="padding-right:90px">
                                                                    <a href="http://'.$config_url.'/chinh-sach-bao-mat" style="text-decoration:none;color:#9a9a9a;font-family:Helvetica,Arial,sans-serif">Chính sách bảo mật</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
