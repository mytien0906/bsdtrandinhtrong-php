...
var pages = ['cover', 'cover', 'page1', 'page1', 'page2', 'page2', 'page3', 'page3', 'page4', 'page4', 'page5', 'page5', 'page6', 'page6', 'page7', 'page7', 'page8', 'page8', 'page9', 'page9', 'page10', 'page10', 'page11', 'page11', 'page12', 'page12', 'page13', 'page13', 'page14', 'page14', 'page15', 'page15', 'back-cover', 'back-cover'],
...
function fbFirstRun(flipbook, fbCont) {
	...
	fbCont.find('div.next').css('left', $(window).width() * 0.5);
	// adjust shadows
