   ...
   <div class="show-register">
       <div class="box-register bx-border bg-white pd-20 w-100 f-left">
       		<form method="post" action="dang-ky.html" id="frm-register" name="frm-register">
				...
				<div class="row-input mb-15 clearfix">
					<input type="text" class="txt-input" id="dienthoai" name="data[dienthoai]" value="" placeholder="Điện thoại đăng nhập">
					<p class="error-text cl-red"></p>
				</div>
				<div class="row-input mb-15 clearfix">
				...
				<div class="row-input t-right clearfix">
			  		<input type="button" onclick="window.location.href=''" class="button bg-light cl-white t-uppercase" value="Thoát">
					<input type="button" value="<?=_register?>" id="register" class="button bg-orange bd-orange cl-white t-uppercase">
				</div>
       		</form>
       </div>
    </div>
