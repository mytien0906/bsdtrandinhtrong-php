<div class="content w-100 mt-10 clearfix">
   ...
   <div class="right-account f-right">
   		<div class="title bx-border w-100">
			<h4 class="t-uppercase ds-inline-block p-relative"><a href="kiem-tra-don-hang.html" title="Kiểm tra đơn hàng">Kiểm tra đơn hàng</a></h4>
		</div>
		<div class="content w-100 mt-10 clearfix">
		...
		<div class="title bx-border w-100 mt-20">
			<h4 class="t-uppercase ds-inline-block p-relative"><a href="kiem-tra-don-hang.html" title="<?=($message=='') ? 'Thông tin đơn hàng':$message?>"><?=($message=='') ? 'Thông tin đơn hàng':$message?></a></h4>
		</div>
		<div class="content w-100 mt-10 clearfix">
			<?php if($order){ ?>
			<table class="banggia">
