...
';
  ...
  $where = " #_baiviet where hienthi=1 and type='san-pham' and noibat=1 ";
  $where .= $where_tk;
  ...
  $sql = "select id,ten_$lang as ten, mota_$lang as mota,tenkhongdau,photo,thumb,type,giaban,giacu,id_city,id_dist,id_ward,id_list,id_user,ngaytao,hoten,donvi,dientich,giachu,id_giatinh from $where $limit";
  $d->query($sql);
  $product_index = $d->result_array();
