	...
	<div class="desc-left">
		<div class="menu_nav">
			...
			<ul class="dm_sp">
				...
				?>
		       	<li>
		       		<a href="<?=$sanpham_menu[$i]['tenkhongdau']?>" title="<?=$sanpham_menu[$i]['ten']?>"><?=$sanpham_menu[$i]['ten']?></a>
		       		<?php /*if(count($sanpham_menu_lv)){ ?>
					<ul>
						<?php for($k=0;$k<count($sanpham_menu_lv);$k++){ ?>
				       	<li>
				       		<a href="<?=$sanpham_menu_lv[$k]['tenkhongdau']?>" title="<?=$sanpham_menu_lv[$k]['ten']?>">+ <?=$sanpham_menu_lv[$k]['ten']?></a>
				       	</li>
					    <?php } ?>
					</ul>
					<?php }*/ ?>
...
<div class="tt-leftsub-dm">
	...
	<div class="tt-desc-left bgx">
		...
		<div class="icon2_hotro">
			<?php for($i=0, $count=count($yahoo); $i<$count;$i++){?>
			<p style="line-height: 25px; color: #0864c4;">
